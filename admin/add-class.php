                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <select  name="section" class="form-control" required='true'>
                          ...
                          <option value="A">Fy.BBA.CA A</option>
                          <option value="B">Fy.BBA.CA B</option>
                          <option value="C">Sy.BBA.CA A</option>
                          <option value="D">Sy.BBA.CAB</option>
                          <option value="E">Ty.BBA.CA A</option>
                          <option value="F">Ty.BBA.CAB</option>
                        </select>
                      </div>
